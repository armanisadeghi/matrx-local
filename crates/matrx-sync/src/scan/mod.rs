...
//! | [`locked`] | The retry schedule for a file another program is holding — deferred and retried, never dropped. |
...
pub use locked::{giveup_remedy, next_attempt, Deferral, RetryPolicy, RetryVerdict};
