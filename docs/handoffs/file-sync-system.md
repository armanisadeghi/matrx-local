...
- Server wire contract: aidream `packages/matrx-files/matrx_files/api/router_files.py` (`/files/sync/changes` + `/files/sync/folders`) + `common-docs/matrx-files-service/FEATURE.md`
