...
class FakeServer:
    ...
    def __init__(self) -> None:
        ...
        self.tool_results_responder: Callable[[httpx.Request], httpx.Response] | None = None
...
def test_delegation_wake_envelope_triggers_sweep(monkeypatch: pytest.MonkeyPatch) -> None:
